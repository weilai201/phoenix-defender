...
import com.zwl.phoenix.defender.phoenix.RestoreWithMultiThreadExecutor;
 ...
 * 
 */
public class PhoenixMultiThreadRestoreKit {
	
	static Logger logger=LoggerFactory.getLogger(PhoenixMultiThreadRestoreKit.class);
	...
	private static void restore() {
		...
		for(File file: list) {
			...
			Long size=RestoreWithMultiThreadExecutor.restore(file);
